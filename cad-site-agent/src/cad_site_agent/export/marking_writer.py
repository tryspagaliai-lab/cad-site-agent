"""
marking_writer.py — Phase 7

Thin convenience wrapper: route marking entities only.

Public API
----------
    run_marking_write(source_dxf, candidates_json, output_dxf, **kwargs)
        -> RoutingReport
"""
...
def run_marking_write(
    ...
    *,
    ...
    """Route only marking entities to the output DXF.

    Calls run_route_features with linework, symbols and text disabled.

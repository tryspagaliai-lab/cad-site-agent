"""
symbol_writer.py — Phase 7

Thin convenience wrapper: route symbol entities only.

Public API
----------
    run_symbol_write(source_dxf, candidates_json, output_dxf, **kwargs)
        -> RoutingReport
"""
...
def run_symbol_write(
    ...
    *,
    ...
    """Route only symbol entities to the output DXF.

    Calls run_route_features with linework, markings and text disabled.
